package mobi.okmobile.bitcointicker.data.local.database

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import mobi.okmobile.bitcointicker.data.local.database.DB.DATABASE_NAME
import mobi.okmobile.bitcointicker.data.local.database.DB.DATABASE_VERSION
